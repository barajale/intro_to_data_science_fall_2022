...
# ╔═╡ 3dc04c18-6887-11ed-0efc-294196304584
using LinearAlgebra, CairoMakie, ColorSchemes, Colors

# ╔═╡ 7847b7ed-4711-4182-a77d-0ea1bec9711a
import AlgebraOfGraphics as aog

# ╔═╡ 3a504903-22f1-4245-be9d-9e3f5af971bb
aog.set_aog_theme!(); update_theme!(fontsize=18)

# ╔═╡ 8c42f8f5-d422-40f1-a8ff-9372d422f3e0
function viz_stochastic_matrix(P, states; add_text::Bool=true, resolution=(1200, 1200))
	fig = Figure(resolution=resolution)
	ax = Axis(fig[1, 1], 
		xticks=(1:length(states), states), yticks=(1:length(states), reverse(states)),
		aspect=DataAspect(),
		xlabel="current state", ylabel="next state"
	)
	P_hm = reverse(P, dims=1)'
	heatmap!(P_hm, colormap=ColorSchemes.amp, colorrange=(0.0, 1.0))
	if add_text
		for i = 1:length(states)
			for j = 1:length(states)
				text!(i, j, text="$(P_hm[i, j])", align=(:center, :center))
			end
		end
	end
	return fig
...
# ╔═╡ 5b608320-3959-4f06-b3bc-d769272d598d
viz_stochastic_matrix(rand(3, 3), ["state 1", "state 2", "state 3"])

# ╔═╡ 2bf013a3-a0f7-496c-8e50-6705928031f5
md"## Gambler's ruin

this problem is from Exercise 12.2.12 [here](https://stats.libretexts.org/Bookshelves/Probability_Theory/Book%3A_Introductory_Probability_(Grinstead_and_Snell)/12%3A_Random_Walks/12.02%3A_Gambler%27s_Ruin).

!!! note \"a Gambler's ruin problem\"
...
# ╔═╡ 0643e1a1-7704-49d3-827b-52dd0a06685e
md"💰 construct and visualize the stochastic matrix describing this Markov chain.
"

# ╔═╡ 48e0fb2c-8532-4e48-9c3b-9c24b483917d


# ╔═╡ 75ce15bd-30f6-4ef6-b62f-f3bd1f4d1704
md"💰 compute the eigenvalues and eigenvectors. you should see an eigenvalue of 1 with multiplicity two. why are there two? look at the eigenvector."

# ╔═╡ 663e25d6-b404-4130-917c-f809e8e21a30


# ╔═╡ a37ff09a-a4df-4ca2-b730-0e2c98196526
md"💰 take a very large power of the stochastic matrix to answer the question: if the gambler starts with $40, what is the probability she will reach $50?
"

# ╔═╡ b05e383f-7b2f-4df7-a4a9-8636b45f9a70
...
julia_version = "1.8.1"
manifest_format = "2.0"
project_hash = "424b99d70373e096512c41070bd11f6962be5cbc"
